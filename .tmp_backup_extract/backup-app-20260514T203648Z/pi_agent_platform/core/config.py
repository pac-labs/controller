...
class WorkspaceProfile(BaseModel):
    ...
    protected_paths: list[str] = Field(default_factory=list, description="Glob patterns for paths that humans should not modify, e.g. ['config/', 'tls/**', '*.key']")
    human_write_policy: Literal["deny", "ask", "allow"] = "deny"
